    ...
    <section>
        <div className="mx-auto max-w-screen-2xl px-4 py-0 sm:px-6 lg:px-8">
            ...
            <div className="relative flex items-center bg-gray-100">
                ...
                <a
                    href="#"
                    className={`${styles.pinkBcg} mt-8 inline-block rounded border px-12 py-3 text-sm font-medium text-white hover:bg-transparent  focus:outline-none focus:ring`}
                >
                    Get in Touch
                </a>
                </div>
